                                ...
                                <div class="form-row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" size="1" style="opacity: 0;" name="university_status" id="universityStatus" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" size="1" style="opacity: 0;" id="universityPopular" name="university_popular" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" size="1" style="opacity: 0;" id="universityNew" name="university_new" required>
                                ...
                                <div class="form-row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" size="1" style="opacity: 0;" id="universityType" name="university_type" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" size="1" style="opacity: 0;" id="universityProgramType" name="university_program_type" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" size="1" style="opacity: 0;" id="universityCourseOffered" name="university_course_offered" required>
                                                <?php
