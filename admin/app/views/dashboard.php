      ...
      <div class="page-header">
        <div class="row align-items-center">
          ...
          <div class="col-sm-auto">
            <a class="btn btn-primary" href="javascript:;" data-toggle="modal" data-target="#inviteUserModal"> <i class="tio-user-add mr-1"></i> Invite users </a>
          </div>
        </div>
      </div>
      <!-- End Page Header -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              ...
              <span class="badge badge-soft-success"> <i class="tio-trending-up"></i> 12.5% </span>
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              ...
              <span class="badge badge-soft-success"> <i class="tio-trending-up"></i> 1.7% </span>
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              ...
              <span class="badge badge-soft-danger"> <i class="tio-trending-down"></i> 4.4% </span>
            ...
            <div class="card-header">
              ...
              <div class="hs-unfold">
                ...
                <div id="reportsOverviewDropdown2" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right mt-1">
                  ...
                  <a class="dropdown-item" href="#"> <i class="tio-share dropdown-item-icon"></i> Share chart </a>
                  <a class="dropdown-item" href="#"> <i class="tio-download-to dropdown-item-icon"></i> Download </a>
                  <a class="dropdown-item" href="#"> <i class="tio-alt dropdown-item-icon"></i> Connect other apps </a>
            ...
            <div class="card-body">
              ...
              <ul class="list-group list-group-flush list-group-no-gutters">
                ...
                <li class="list-group-item py-3">
                  <div class="media">
                    <div class="mt-1 mr-3">
                      <img class="avatar avatar-xs avatar-4by3" src="<?= $base_URI; ?>/app/assets/svg/brands/capsule.svg" alt="Image Description" />
                    </div>
                ...
                <li class="list-group-item py-3">
                  <div class="media">
                    <div class="mt-1 mr-3">
                      <img class="avatar avatar-xs avatar-4by3" src="<?= $base_URI; ?>/app/assets/svg/brands/mailchimp.svg" alt="Image Description" />
                    </div>
                    <div class="media-body">
                      <div class="row align-items-center">
                        <div class="col">
                ...
                <li class="list-group-item">
                  <small>Or you can <a href="#">sync data to Front Dashboard</a> to ensure your data is always up-to-date.</small>
                </li>
              </ul>
            </div>
            <!-- End Body -->
              ...
              <div class="row mb-4">
                <div class="col-sm mb-2 mb-sm-0">
                  <div class="d-flex align-items-center">
                    ...
                    <span class="text-success ml-2"> <i class="tio-trending-up"></i> 25.3% </span>
                  </div>
                </div>
                ...
                <div class="col-sm-auto align-self-sm-end">
                  ...
                  <div class="row font-size-sm">
                    <div class="col-auto"><span class="legend-indicator bg-primary"></span> New</div>
                    <div class="col-auto"><span class="legend-indicator"></span> Overdue</div>
                  </div>
          ...
          <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><span class="legend-indicator bg-danger"></span>Overdue</td>
              ...
              <tr>
                ...
                <td class="table-column-pl-0">
                  <a class="media align-items-center" href="./user-profile.html">
                    <div class="avatar avatar-sm avatar-circle mr-2">
                      <img class="avatar-img" src="<?= $base_URI; ?>/app/assets/img/160x160/img9.jpg" alt="Image Description" />
                    </div>
                    <div class="media-body">
              ...
              <tr>
                ...
                <td class="table-column-pl-0">
                  <a class="media align-items-center" href="./user-profile.html">
                    <div class="avatar avatar-sm avatar-circle mr-2">
                      <img class="avatar-img" src="<?= $base_URI; ?>/app/assets/img/160x160/img4.jpg" alt="Image Description" />
                    </div>
                    <div class="media-body">
          ...
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-auto"><span class="legend-indicator" style="background-color: #7000f2;"></span> Pending</div>

                <div class="col-auto"><span class="legend-indicator bg-info"></span> Failed</div>
              </div>
              <!-- End Legend Indicators -->
            </div>
            <!-- End Body -->
            ...
            <div class="card-header">
              ...
              <div class="hs-unfold">
                ...
                <div id="reportsOverviewDropdown1" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right mt-1">
                  ...
                  <a class="dropdown-item" href="#"> <i class="tio-share dropdown-item-icon"></i> Share reports </a>
                  <a class="dropdown-item" href="#"> <i class="tio-download-to dropdown-item-icon"></i> Download </a>
                  <a class="dropdown-item" href="#"> <i class="tio-alt dropdown-item-icon"></i> Connect other apps </a>
            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table class="table table-lg table-nowrap card-table mb-0">
                  <tr>
                    <th scope="row"><span class="legend-indicator bg-primary"></span>Gross value</th>
                    <td>$3,500.71</td>
                    <td>
                  ...
                  <tr>
                    <th scope="row"><span class="legend-indicator bg-primary opacity"></span>Net volume from sales</th>
                    <td>$2,980.45</td>
                    <td>
                  ...
                  <tr>
                    <th scope="row"><span class="legend-indicator bg-primary opacity-xs"></span>New volume from sales</th>
                    <td>$950.00</td>
                    <td>
                  ...
                  <tr>
                    <th scope="row"><span class="legend-indicator"></span>Other</th>
                    <td>32</td>
                    <td>
