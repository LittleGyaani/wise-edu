      ...
      <div class="navbar-vertical-content">
        <ul class="navbar-nav navbar-nav-lg nav-tabs">
          ...
          <li class="navbar-vertical-aside-has-menu show">
            ...
            <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: block; transition: unset; top: 60px;">
              <li class="nav-item">
          ...
          <li class="navbar-vertical-aside-has-menu nav-footer-item ">
            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle " href="javascript:;" title="Language">
              <img class="avatar avatar-xss avatar-circle" src="http://localhost/wise/admin/app/assets/vendor/flag-icon-css/flags/1x1/us.svg" alt="United States Flag">
            ...
            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
              <li class="nav-item">
                <a class="nav-link" href="#" title="English (US)">
                  <img class="avatar avatar-xss avatar-circle mr-2" src="http://localhost/wise/admin/app/assets/vendor/flag-icon-css/flags/1x1/us.svg" alt="Flag">
                  English (US)
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" title="English (UK)">
                  <img class="avatar avatar-xss avatar-circle mr-2" src="http://localhost/wise/admin/app/assets/vendor/flag-icon-css/flags/1x1/gb.svg" alt="Flag">
                  English (UK)
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" title="Deutsch">
                  <img class="avatar avatar-xss avatar-circle mr-2" src="http://localhost/wise/admin/app/assets/vendor/flag-icon-css/flags/1x1/de.svg" alt="Flag">
                  Deutsch
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" title="Dansk">
                  <img class="avatar avatar-xss avatar-circle mr-2" src="http://localhost/wise/admin/app/assets/vendor/flag-icon-css/flags/1x1/dk.svg" alt="Flag">
                  Dansk
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" title="Italiano">
                  <img class="avatar avatar-xss avatar-circle mr-2" src="http://localhost/wise/admin/app/assets/vendor/flag-icon-css/flags/1x1/it.svg" alt="Flag">
                  Italiano
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" title="中文 (繁體)">
                  <img class="avatar avatar-xss avatar-circle mr-2" src="http://localhost/wise/admin/app/assets/vendor/flag-icon-css/flags/1x1/cn.svg" alt="Flag">
                  中文 (繁體)
                </a>
              </li>
            </ul>
